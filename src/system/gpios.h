...
#define ROW1_PIN        39  // Changed from 22 to free GPIO 1 for TX
#define ROW2_PIN        38  // Changed from 1 to free GPIO 1 for TX
#define ROW3_PIN        37  // Changed from 32
#define ROW4_PIN        36  // Changed from 12
...
// Pin 9: GPIO 22 - See COL1_PIN (keypad column 1)
...
// Pin 16: GPIO 12 - Previously ROW4_PIN, now free (ROW4 moved to GPIO 36)
...
// Pin 7: GPIO 39 - See ROW1_PIN (keypad row 1)
#define JP3_PIN7_GPIO39     39
// Pin 6: GPIO 38 - See ROW2_PIN (keypad row 2)
#define JP3_PIN6_GPIO38     38
// Pin 5: GPIO 37 - See ROW3_PIN (keypad row 3)
#define JP3_PIN5_GPIO37     37
// Pin 4: GPIO 36 - See ROW4_PIN (keypad row 4)
...
// 
// Keypad Pins (freed GPIO 1 and 3 for TX/RX):
//   Columns: 22, 23, 2, 17, 13
//   Rows: 39, 38, 37, 36
// 
// Free GPIOs for UART:
//   GPIO 1: U0TXD (TX) - Now free (ROW2 moved from 1 to 38)
//   GPIO 3: U0RXD (RX) - Now free (COL1 moved from 3 to 22)
// 
